  ...
  return (
    <>
      ...
      <section className="space-y-4">
        ...
        <p>
          I'm the technical co-founder of a stealth AI start-up. Before that, I
          shaped products at{" "}
          <Link href="https://relevanceai.com">Relevance AI</Link> from seed to
          Series A. I built infrastructure, internal tooling and apps at{" "}
        ...
        <p>
          Aside from work, I love sunrises/sunsets, good food, long walks, time
          spent with loved ones, and most importantly — time to learn, think,
          create and do.
        </p>
        <p>
          You can reach me at{" "}
